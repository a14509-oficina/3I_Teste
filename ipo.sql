...
CREATE TABLE IF NOT EXISTS `cliente` (
  ...
  PRIMARY KEY (`codcli`),
  KEY `nif` (`nif`)
) ENGINE=InnoDB AUTO_INCREMENT=1008002 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
CREATE TABLE IF NOT EXISTS `empregados` (
  ...
  `funcao` varchar(50) COLLATE utf8mb4_general_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `inspecao` (
  ...
  PRIMARY KEY (`codinspecao`),
  KEY `codcli` (`codcli`),
  KEY `codmatricula` (`codmatricula`),
  KEY `codinspetor` (`codinspetor`),
  KEY `datainspecao` (`datainspecao`)
...
CREATE TABLE IF NOT EXISTS `proprietario_veiculo` (
  ...
  PRIMARY KEY (`idProProprietarioVeiculo`),
  KEY `idProprietario` (`idProprietario`,`idVeiculo`),
